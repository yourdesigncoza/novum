...
/*----------------------------------------YDCOZA----------------------------------------*/
/*  Gap [ydcoza_gap size="10"]  size in px */
/*--------------------------------------------------------------------------------------*/
function ydcoza_gap_custom( $atts ){
    $size = shortcode_atts( array(
        'size' => '10',
    ), $atts );

    return "<div class='clearfix' style='margin-bottom:{$size['size']}px; height:1px'></div>";
}
add_shortcode( 'ydcoza_gap', 'ydcoza_gap_custom' );

/*----------------------------------------YDCOZA----------------------------------------*/
/*      Base URL [base_url]/  */
/*--------------------------------------------------------------------------------------*/
function ydcoza_base_url() {
    return site_url();
}
add_shortcode('base_url', 'ydcoza_base_url');

/*----------------------------------------YDCOZA----------------------------------------*/
/*      [ydcoza_button class="outline" title="My Button" url="permalink"] */
/*--------------------------------------------------------------------------------------*/
 /* Shortcode to display an action button. */
add_shortcode( 'ydcoza_button', 'ydcoza_button' );
function ydcoza_button( $atts ) {
       ...
       return '<a class="button ' . $class . '" href="'. site_url() . '/' . $url . '">' . $title . '</a>';
}



/**
 * Social Links Uses Social URLs specified in Yoast SEO. See SEO > Social
 *
 */
/*----------------------------------------YDCOZA----------------------------------------*/
/* Social Links Uses Social URLs specified in Yoast SEO. See SEO > Social */
/*   [social_links] */
/*--------------------------------------------------------------------------------------*/
// https://www.billerickson.net/code/displaying-social-links-from-yoast-seo/
